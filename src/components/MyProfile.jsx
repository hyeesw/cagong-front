    ...
    <>
      <Dropdown>
        <Dropdown.Toggle as={CustomToggle} id="dropdown-custom-components">
          <img src="/images/profile.jpg" alt="프로필이미지" style={{ width: "50px", height: "50px" }}/>
        </Dropdown.Toggle>
        <Dropdown.Menu style={{ minWidth: '400px', padding: '20px' }}>
          ...
          <div className="d-flex align-items-center justify-content-center mb-3">
            <img src="/images/profile.jpg" alt="프로필이미지" style={{ width: "100px", height: "100px", textAlign: 'center' }}/>
          </div>
